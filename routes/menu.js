...
function getMenuByShopId(req, res, shopId) {
  const shopSql = `
    SELECT shop_name, shopkeeper_name, email, photo, IFNULL(logo, NULL) AS logo, phone, categories, address, payments, have_deliverymen, deli_fees_method, open_shop, location 
